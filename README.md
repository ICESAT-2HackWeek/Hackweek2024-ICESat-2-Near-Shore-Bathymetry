...
<p align="justify">
We would also try our hands on machine learning models to see if we can train a model with Sentinel-2 optical spectral data and ground reference bathymetry measurements. And if time permits, we will peep into the depths of the drifting Arctic meltponds.
