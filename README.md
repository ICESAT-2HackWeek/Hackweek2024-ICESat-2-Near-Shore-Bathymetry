...
<p align="justify">
Photons are tiny little particles of light, far too small to see individually. All light is made of photons. Only a small percentage of laser light photons make it back to the satellite, which are extremely valuable to scientific research. 

Here is DIY ("ICESat-2 Bouncy Ball Photon Collection Activity") to develop a gut feeling about the photon scattering process: https://icesat-2.gsfc.nasa.gov/sites/default/files/funzone/ICESat-2_PhotonCountingActivity_BouncyBalls_FINAL%20508%20Compliant.pdf
</p>
