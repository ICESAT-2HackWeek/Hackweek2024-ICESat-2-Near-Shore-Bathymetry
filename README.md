...
<p align="justify">
ii) We would like to try our hands on machine learning models to see if we can train a model with Sentinel-2 optical spectral data and ground reference bathymetry measurements.<br /> iii) If time permits we will have a chance to peep into the depths of drifting Arctic meltponds.
</p>
